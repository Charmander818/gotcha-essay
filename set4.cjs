...
const questions = [
  // Oct/Nov 2023 42
  {
    year: "2023", paper: "9708/42", variant: "Oct/Nov", questionNumber: "2", topic: "SyllabusTopic.PRICE_SYSTEM_AL", chapter: "7.1 Utility and consumer behaviour", maxMarks: 20,
...
• IC analysis is a static analysis and consumer preferences may change over time.`
  ...
  {
    year: "2023", paper: "9708/42", variant: "Oct/Nov", questionNumber: "3", topic: "SyllabusTopic.PRICE_SYSTEM_AL", chapter: "7.5 Perfect competition", maxMarks: 20,
...
• The impact of monopoly profits on the ability to spend on research and development (R&D), and the implications for dynamic efficiency.`
  ...
  {
    year: "2023", paper: "9708/42", variant: "Oct/Nov", questionNumber: "4", topic: "SyllabusTopic.INTERNATIONAL_AL", chapter: "11.3 Role of multinational companies (MNCs)", maxMarks: 20,
...
• The jobs created in the local environment may be low-skilled, with the multinational employing expatriate workers for the more senior and skilled roles.`
  ...
  {
    year: "2023", paper: "9708/42", variant: "Oct/Nov", questionNumber: "5", topic: "SyllabusTopic.MACRO_AL", chapter: "9.1 National income statistics", maxMarks: 20,
